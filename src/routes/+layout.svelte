...
<nav>
  ...
  <a href={`${basePath}/projects`} class={$page.url.pathname.startsWith('/projects') ? 'active' : ''}>Projects</a>
  <a href={`${basePath}/contact`} class={$page.url.pathname.startsWith('/contact') ? 'active' : ''}>Contact</a>
  <a href={`${basePath}/cv`} class={$page.url.pathname.startsWith('/cv') ? 'active' : ''}>CV</a>
