...
<nav>
    <a href="/my-portfolio/" class={$page.url.pathname === '/my-portfolio/' ? 'active' : ''}>Home</a>
    <a href="/my-portfolio/projects" class={$page.url.pathname === '/my-portfolio/projects' ? 'active' : ''}>Projects</a>
